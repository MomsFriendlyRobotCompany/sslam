...
PyObject *null_on_raise_argument_exception_with_details(
...
* @return NULL
*/
PyObject *null_on_raise_argument_exception(
    const char * classname,
    const char *  methodname);
...
* @return -1
*/
int error_on_raise_argument_exception_with_details(
    const char * classname,
    const char *  methodname,
    const char * details);
...
*/
int error_on_check_argument_type(
    PyObject * obj,
    PyTypeObject * typ,
    int pos,
    const char * typname,
